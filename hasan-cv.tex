...
\text{Cell:} +974-3372-4994 \\
\text{E-mail:} \email{hasan.abbas@qatar.tamu.edu}\\
}
\end{tabular}
%%
...
\begin{bibenum}
\item[2018] H.~T.~, Abbas, X.~, Zeng, R.~D.~, Nevels, M.~S.~, Zubairy, ``Deep sub-wavelength imaging via tunable terahertz plasmons'', Applied Physics Letters 113 (5), 051106.

\item[2018] H.~T.~, Abbas, R.~D.~, Nevels, K.~A.~, Michalski, ``An Integral Equation Scheme for Two-dimensional Electromagnetic Systems'', \emph{to appear in IEEE Transactions of Antennas \& Propagation}.

\item[2018] H.~T.~, Abbas, L.~, Alic, M.~, Erraguntla,  Q.~, Abbasi,  M.~, AbdulGhani,  M.~, Qaraqe, ``Using Oral Glucose Tolerance Test and Support Vector Machine to predict Type 2 Diabetes'', \emph{submitted to IEEE Journal of Biomedical Health \& Informatics}.

\item[2018] M.~, Shafiqul-Islam, H.~T.~, Abbas, M.~, Erraguntla,  Q.~, Abbasi,  M.~, AbdulGhani,  M.~, Qaraqe,, ``Predicting Future Progression of Type 2 Diabetes
Through Applying Machine Learning Approaches'', \emph{submitted to IEEE Access}.

\item[2018] A.~, Zahid, H.~T.~, Abbas, A.~, Alomainy, Q.~, Abbasi, ``Determination of Plant Health using Terahertz Spectroscopy of leaves'', \emph{submitted to IEEE Transactions of Terahertz Science \& Technology}.
...
\begin{bibenum}
    \item[2015]R.~D.~Nevels, H.~T.~Abbas, ``Optical Nanoantennas'', In Chapter in Handbook of Antenna Technologies, Springer Singapore, pp. 1-33, 2015.
\end{bibenum}
...
\item[2019] H.~T.~, Abbas, Q.~, Abbasi, Y.~, Boudjemline, Z.~, Hijazi, B.~, Mansoor, K.~, Qaraqe, ``Remote Monitoring of Absorbable Cardiovascular Stents using mm-waves'' In EuCAP, 2019 European Conference on Antennas \& Propagation.

\item[2019] A.~, Abohmra, F.~, Jilani, H.~T.~, Abbas, A.~, Alomainy, M.~, Imran, Q.~, Abbasi, `` Terahertz Antenna based on Graphene for Wearable Applications'' In  EuCAP, 2019 European Conference on Antennas \& Propagation.

\item[2019] L.~, Alic, H.~T.~, Abbas, M.~, Rios, M.~, Abdul-Ghani, K.~, Qaraqe, ``Predicting Diabetes in Healthy Population through Machine Learning'' In  HealtInf, 2019 International Conference on Health Informatics.
...
\begin{outerlist}
\item[] \textit{QNRF NPRP 11-C} \hfill \textbf{Fall 2018}
    \begin{innerlist}
        ...
        \begin{innerlist}
            \item[] Under review (USD 5 million)
        \end{innerlist}
    \end{innerlist}

\item[] \textit{TEES - RRSF 2018-2019} \hfill \textbf{Fall 2018}
    \begin{innerlist}
        ...
        \end{innerlist}
    \end{innerlist}
\item[] \textit{Qatar University - IRCC 2018-2019} \hfill \textbf{Fall 2018}
    \begin{innerlist}
        ...
        \end{innerlist}
    \end{innerlist}
\item[] \textit{Sidra Medicine - IRF 2018-2019} \hfill \textbf{Fall 2018}
    \begin{innerlist}
...
\begin{enumerate}[itemsep=0mm]
    ...
    \item Prof. Amin Jayyousi, Weill-Cornell Medicine, Qatar.
    \item Dr. Muhammad Al-Amri, King Abdullah City of Science \& Technology, KSA.
    \item Dr. Ebaa Al-Ozairi, Dasman Institute, Kuwait.
